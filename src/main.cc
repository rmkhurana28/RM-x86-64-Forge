...
int main() {
    ...
    if (parser.parse()) {
        ...
        system("cat output/01_3-addr_code.txt output/02_2-addr_code.txt output/03_cfg.txt output/04_optimized_2-addr_code.txt output/05_interference_graph.txt > output/00_all_in_one.txt");
